...
For network programing, \emph{Wireshark} or \emph{tcpdump} is a very nice tool for debugging. Observe the inbound and outbound packets to check if you really send or receive the messages and weather they satisfy the format of the protocol.
