...
\textbf{TODO}: We tried to follow RFC2119\cite{rfc2119} in this document, but obviously some students were not familiar with it and thus misunderstood the requirements.

\textbf{TODO}: Check if this assignment overlaps with T-110.4100.
\vskip 15pt
...
\vskip 15pt
\textbf{TODO}: think about the TTL for a Query Hit, what value is appropriate?
...
\textbf{Resource ID (Xnd)}: The ID of the resource. (\textbf{TODO}: what is this for?)
...
\vskip 15pt
\textbf{TODO}: should we allow \TeX source or plain text format for report?
\vskip 15pt
