...
\item Publish a key at your node and make it visible to other nodes in the P2P network.
...
Each entry provides: resource ID (unique for the sharing node) and resource value.
