...
Think about the TTL for a Query Hit, what value is appropriate? If you have no idea about the network topology, then probably it should be fixed at 5.
...
Resource ID and value pairs are implementation dependant. 
